...
-- Fix the security warning by adding SET search_path to the get_current_user_email function
...
-- Also update the redeem_code function to include proper search_path setting
